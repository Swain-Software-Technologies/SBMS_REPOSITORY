 ...
 */
package com.sstech.spring.boot.rest.controller;
...
import com.sstech.spring.boot.rest.model.Student;
import com.sstech.spring.boot.rest.model.Students;
...
public class StudentRestController {
	...
	@RequestMapping(value = "/student/{stdId}", produces = {"application/json","application/xml"})
